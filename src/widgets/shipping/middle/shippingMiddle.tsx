  ...
  return (
    <div className={'flex flex-col gap-10'}>
      <div className={'space-y-5'}>
        <h3 className={'text-title-third text-3xl'}>Доставка</h3>
      ...
      <div className={'space-y-5'}>
        <h4 className={'text-title-third'}>В пределах Москвы и области</h4>
      ...
      <div className={'space-y-5'}>
        <h4 className={'text-title-third'}>В регионы</h4>
