...
const ProfileHistoryItem: React.FC<ProfileHistoryItemProps> = ({
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center px-5 pt-1.5 pb-2 mt-1.5 w-full bg-white rounded-lg min-w-[420px] max-md:max-w-full max-md:flex-col max-md:min-w-0 hover:bg-gray-50 transition-colors">
