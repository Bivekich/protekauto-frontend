    ...
    <header className="section-4">
      <section className="top_head">
        <div className="w-layout-blockcontainer container nav w-container">
          ...
          <Link href="/" legacyBehavior><a href="/" className="brand w-nav-brand"><img src="/images/logo.svg" loading="lazy" alt="" /></a></Link>
            <nav role="navigation" className="nav-menu w-nav-menu">
              <Link href="/about" legacyBehavior><a className="nav-link w-nav-link">О компании</a></Link>
              <Link href="/payments-method" legacyBehavior><a className="nav-link w-nav-link">Оплата и доставка</a></Link>
              <Link href="/" legacyBehavior><a className="nav-link w-nav-link">Гарантия и возврат</a></Link>
              <Link href="/payments-method" legacyBehavior><a className="nav-link w-nav-link">Покупателям</a></Link>
              <Link href="/wholesale" legacyBehavior><a className="nav-link w-nav-link">Оптовым клиентам</a></Link>
              <Link href="/contacts" legacyBehavior><a className="nav-link w-nav-link">Контакты</a></Link>
            </nav>
            ...
            <div
              ...
              <div className="form-block w-form">
                ...
                >
                  ...
                  <input className="text-field w-input" maxLength={256} name="customSearch" data-custom-input="true" placeholder="Введите код запчасти или VIN номер автомобиля" type="text" id="customSearchInput" required />
                </form>
              ...
              <div className="w-layout-hflex flex-block-76">
                <Link href="/favorite" legacyBehavior>
                  <a className="button_h w-inline-block">
