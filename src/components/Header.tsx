    ...
    <section className="top_head">
      <div className="w-layout-blockcontainer container nav w-container">
        <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" className="navbar w-nav">
          <a href="#" className="brand w-nav-brand"><img src="/images/logo.svg" loading="lazy" alt="" /></a>
          <nav role="navigation" className="nav-menu w-nav-menu">
            <a href="#" className="nav-link w-nav-link">О компании</a>
            <a href="#" className="nav-link w-nav-link">Оплата и доставка</a>
            <a href="#" className="nav-link w-nav-link">Гарантия и возврат</a>
            <a href="#" className="nav-link w-nav-link">Покупателям</a>
            <a href="#" className="nav-link w-nav-link">Оптовым клиентам</a>
            <a href="#" className="nav-link w-nav-link">Контакты</a>
          </nav>
          <div className="w-layout-hflex flex-block-2">
            <div className="w-layout-hflex flex-block-3">
              <div className="w-layout-hflex flex-block-77-copy">
                <div className="code-embed-4 w-embed"><svg width="24" height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.51667 8.99167C6.71667 11.35 8.65 13.275 11.0083 14.4833L12.8417 12.65C13.0667 12.425 13.4 12.35 13.6917 12.45C14.625 12.7583 15.6333 12.925 16.6667 12.925C17.125 12.925 17.5 13.3 17.5 13.7583V16.6667C17.5 17.125 17.125 17.5 16.6667 17.5C8.84167 17.5 2.5 11.1583 2.5 3.33333C2.5 2.875 2.875 2.5 3.33333 2.5H6.25C6.70833 2.5 7.08333 2.875 7.08333 3.33333C7.08333 4.375 7.25 5.375 7.55833 6.30833C7.65 6.6 7.58333 6.925 7.35 7.15833L5.51667 8.99167Z" fill="currentColor"/></svg></div>
        ...
        <div className="w-layout-hflex flex-block-4">
          <div data-animation="default" data-collapse="medium" data-duration="400" data-easing="ease" data-easing2="ease" role="banner" className="navbar-2 w-nav">
            <div className="menu-button w-nav-button">
              <div className="code-embed-5 w-embed"><svg width="currentwidth" height="currentheight" viewBox="0 0 30 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 0H30V3H0V0Z" fill="currentColor"/><path d="M0 7.5H30V10.5H0V7.5Z" fill="currentColor"/><path d="M0 15H30V18H0V15Z" fill="currentColor"/></svg></div>
            </div>
          </div>
          <div className="form-block w-form">
            <form id="wf-form-search" name="wf-form-search" data-name="search" action="http://search" method="post" className="form" data-wf-page-id="6836c4d0a840357cccfad382" data-wf-element-id="14d3a852-00ba-b161-8849-a97059b3785d">
              <a href="#" className="link-block-3 w-inline-block">
                <div className="code-embed-6 w-embed"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17.5 17.5L13.8834 13.8833" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><path d="M9.16667 15.8333C12.8486 15.8333 15.8333 12.8486 15.8333 9.16667C15.8333 5.48477 12.8486 2.5 9.16667 2.5C5.48477 2.5 2.5 5.48477 2.5 9.16667C2.5 12.8486 5.48477 15.8333 9.16667 15.8333Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg></div>
              </a><input className="text-field w-input" maxLength={256} name="Search" data-name="Search" placeholder="Введите код запчасти или VIN номер автомобиля" type="text" id="Search-4" required />
            </form>
          ...
          <div className="w-layout-hflex flex-block-76">
            <a href="https://help.webflow.com" className="button_h w-inline-block">
            ...
            <div className="button_h login w-inline-block" style={{ position: 'relative' }}>
              <AuthForm />
            </div>
            <a href="#" className="button_h w-inline-block">
