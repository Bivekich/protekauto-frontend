        ...
        <div className="w-layout-blockcontainer container nav w-container">
          <div className="w-layout-hflex flex-block-4">
            <div data-animation="default" data-collapse="all" data-duration="400" data-easing="ease-in" data-easing2="ease" role="banner" className="navbar-2 w-nav">
              ...
              >
                <div className="code-embed-5 w-embed"><svg width="30" height="18" viewBox="0 0 30 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 0H30V3H0V0Z" fill="currentColor" /><path d="M0 7.5H30V10.5H0V7.5Z" fill="currentColor" /><path d="M0 15H30V18H0V15Z" fill="currentColor" /></svg></div>
              </div>
              
            </div>
            <div className="w-layout-hflex flex-block-93">
              <div className="form-block w-form">
                <form id="wf-form-search" name="wf-form-search" data-name="search" action="http://search" method="post" className="form" data-wf-page-id="6834155694a300ddf57ddb5f" data-wf-element-id="14d3a852-00ba-b161-8849-a97059b3785d">
