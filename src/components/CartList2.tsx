  ...
  return (
    <div className="w-layout-vflex flex-block-48">
      <div className="w-layout-vflex product-list-cart-check">
        {items.map((item, idx) => (
          <div
            className={`w-layout-hflex cart-item-check${idx === items.length - 1 ? ' last-child' : ''}`}
            key={item.id}
          >
            ...
            <div className="w-layout-hflex add-to-cart-block-s2">
              <div className="w-layout-hflex flex-block-39-copy">
                <h4 className="delivery-cart-s1">{item.delivery}</h4>
              ...
              <div className="w-layout-hflex flex-block-39-copy-copy">
                <h4 className="price-in-cart-s1">{item.price}</h4>
                <div className="price-1-pcs-cart-s1">{item.pricePerItem}</div>
              </div>
            </div>
          </div>
        ))}
