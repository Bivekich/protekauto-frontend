  ...
  <div className="w-layout-hflex core-product-search-s1">
    <div className="w-layout-vflex core-product-s1">
      <div className="w-layout-vflex flex-block-47">
        <div className="div-block-19">
          <img src="/images/info.svg" loading="lazy" alt="" className="image-9" />
        </div>
        <div className="w-layout-vflex flex-block-50">
          <div className="w-layout-hflex flex-block-79">
            <h3 className="heading-10 name">STELLOX</h3>
            <h3 className="heading-10">1023245SX</h3>
          </div>
          <div className="text-block-21">Комплект ГРМ</div>
        </div>
      </div>
      <div className="div-block-20">
        <img src="/images/image-10.png" loading="lazy" alt="" className="image-10" />
      </div>
    </div>
    ...
    <div className="w-layout-vflex flex-block-48-copy">
      ...
      <div className="w-layout-vflex product-list-search-s1">
        {/* 1 */}
        <div className="w-layout-hflex product-item-search-s1">
          <div className="w-layout-hflex flex-block-81">
            <div className="w-layout-hflex info-block-search-s1">
              ...
              <div className="pcs-search-s1">444 шт</div>
            ...
            <div className="price-s1">от 17 323 ₽</div>
          </div>
...
export default CoreProductCardHTMLCopy; 